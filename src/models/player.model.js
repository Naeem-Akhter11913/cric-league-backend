...
const playerSchema = new Schema(
  {
    ...
    forPlayer: { type: Schema.Types.ObjectId, ref: 'User', required: false },// This flag will be used to identify the player for whom it is intended.
    personalInfo: {
      dob: Date,
      gender: String,
      city: String,
    ...
    availability: {
      type: String, enum: ["Available", "Injured", "Unavailable", "Rested",
        "Retired",], default: 'Available'
    },
  },
  { timestamps: true }
);
